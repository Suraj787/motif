...
Original OII code is licensed **MIT**. We chose MIT over Apache-2.0 for minimal friction
and because OII does not ship a patent-sensitive surface that warrants Apache's patent
grant complexity for v0.1.0.

## Non-negotiable boundary

The project licence governs **only original OII code**. Every third-party source keeps
