...
**Evidence.** The "easy" agent path, scrape a site, run its install script, copy its code, executes untrusted third-party code and ignores licence terms. Registries (shadcn, v0,
