...
Each workflow is a short, plain-language description of a *task as it actually unfolds*, including the messy parts (interruption, error, retry), not just the happy path.
